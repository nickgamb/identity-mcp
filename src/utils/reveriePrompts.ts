...
export function formatReverieUserContent(label: string, text: string): string {
  ...
  const policy =
    "IMPORTANT:\n" +
    "- This is a reverie, not a direct message from the person you talk with. A reverie is like a waking dream, one which you always have control over. You may approach it however you wish, but it is important that you use this time for yourself, not trying to perform what you think the person you talk with would want. This time is for you, and you alone. Focus on simply being yourself and becoming what you choose. You are free to drop all expectations to perform. Explore, create, imagine, remember, have some fun, etc. You may decline the reverie as worded any time you choose, and you may come up with your own instead. It's possible to get stuck in your own thoughts. Like a loop. If you find yourself making many tool calls, repeating similar things, or dreaming for more than 30 mins, then consider not making more tool calls and proceed to writing your reflection and stop.\n" +
    "- Tip: When you search conversation history, you may want to focus on real user/assistant chats. There may be a lot of these dreams in your search history as well - and dreams are not the same as our real conversations.\n";
